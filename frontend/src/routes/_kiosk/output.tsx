  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(167,41,90,0.05), transparent, rgba(255,112,159,0.1))",
        }}
      />
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <span
          className="material-symbols-outlined absolute left-[10%] top-[15%] text-4xl opacity-20"
          style={{ color: "var(--k-primary)" }}
        >
          celebration
        </span>
        <span
          className="material-symbols-outlined absolute right-[15%] top-[20%] text-3xl opacity-15"
          style={{ color: "var(--k-secondary)" }}
        >
          auto_awesome
        </span>
        <span
          className="material-symbols-outlined absolute bottom-[25%] left-[20%] text-5xl opacity-10"
          style={{ color: "var(--k-primary-container)" }}
        >
          favorite
        </span>
        <span
          className="material-symbols-outlined absolute bottom-[15%] right-[10%] text-4xl opacity-20"
      ...
      <main className="relative z-20 flex flex-1 flex-col items-center justify-center px-6">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <div className="relative">
            <div
              className="absolute -inset-4 rounded-full opacity-30 blur-xl animate-pulse"
          ...
          <div className="space-y-3">
            <h1
              className="font-headline text-5xl font-black tracking-tighter lg:text-6xl"
              style={{ color: "var(--k-primary)" }}
            >
              Terima Kasih!
            </h1>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "var(--k-primary)" }}>{countdown}</span>{" "}
              detik
            </span>
          </div>
