  ...
  return (
    ...
    >
      ...
      <main className="flex flex-1 flex-col items-center overflow-y-auto px-6 py-4">
        <h1 className="font-headline mb-6 text-center text-4xl font-black">
          Preview Foto
        </h1>
        ...
        <div className="grid w-full max-w-5xl grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="order-2 md:order-1">
            <h3
              className="font-headline mb-3 text-center text-sm font-bold"
            ...
            <div className="grid grid-cols-2 gap-2">
              {photos.map((photo, i) => (
                <div
                  key={i}
                  className="aspect-square overflow-hidden rounded-lg border-2 border-white shadow-md"
                >
                  <img
                    src={photo}
                    alt={`Raw ${i + 1}`}
        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="mx-6 max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <p
              ...
              style={{ color: "var(--k-on-surface-variant)" }}
            >
              Terima kasih telah menggunakan photobooth. Kembali ke halaman
              utama?
            </p>
