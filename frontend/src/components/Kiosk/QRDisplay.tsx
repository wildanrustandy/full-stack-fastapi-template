  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center rounded-2xl bg-white p-2 shadow-lg">
        ...
        <div className="relative flex h-full w-full items-center justify-center rounded-lg p-4">
          ...
          {isLoading && (
            ...
            >
              ...
              <span className="text-sm font-medium text-[var(--k-on-surface-variant)]">
                Memuat QRIS...
              </span>
            </div>
          )}
          ...
          {error && !qrCodeUrl && (
            <div
              className="flex h-full w-full flex-col items-center justify-center gap-3 rounded-lg p-4"
              style={{ background: "var(--k-error-container)/10" }}
            >
              <span
          ...
          {isDemo && !qrCodeUrl && !isLoading && (
            <div
              className="flex h-full w-full flex-col items-center justify-center gap-3 rounded-lg p-4"
              style={{ background: "var(--k-tertiary-container)/20" }}
            >
              <span
                className="material-symbols-outlined text-5xl"
              ...
              <span className="text-center text-xs text-[var(--k-on-surface-variant)]">
                QRIS tidak tersedia di mode demo
              </span>
            </div>
          )}
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 15px rgba(167,41,90,0.5)",
                }}
              />
            </>
          )}
          ...
          {/* Corner brackets */}
          <div
            className="absolute left-4 top-4 h-12 w-12 rounded-tl-lg border-t-4 border-l-4"
            style={{ borderColor: "var(--k-primary)" }}
          />
          <div
            className="absolute right-4 top-4 h-12 w-12 rounded-tr-lg border-t-4 border-r-4"
            style={{ borderColor: "var(--k-primary)" }}
          />
          <div
            className="absolute bottom-4 left-4 h-12 w-12 rounded-bl-lg border-b-4 border-l-4"
            style={{ borderColor: "var(--k-primary)" }}
          />
          <div
            className="absolute bottom-4 right-4 h-12 w-12 rounded-br-lg border-b-4 border-r-4"
            style={{ borderColor: "var(--k-primary)" }}
          />
        </div>
      </div>
      ...
      <div className="mb-2 mt-3 flex items-center gap-4">
        ...
        <div
          className="h-6 w-px"
          style={{ background: "var(--k-outline-variant)" }}
        />
        <span className="font-headline text-xs font-extrabold uppercase tracking-widest text-[var(--k-on-surface-variant)]">
          GPN
        </span>
